...
<html lang="pt-BR">
  <head>
    ...
    <link rel="stylesheet" href="./css/menu_obra.css">
  </head>
  <body>
    <header>
      <div class="page">
        <nav class="page__menu menu">
          <ul class="menu__list r-list">
            <li class="menu__logo"><img src="https://raw.githubusercontent.com/joaopessin/senai_tcc/main/Sistema%20Funcional/images/logo.png" alt="logo_obra_360"></li>
