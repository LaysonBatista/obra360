...
<body>
    ...
    <header>
            ...
            <nav class="page__menu menu">
                <ul class="menu__list r-list">
                    ...
                    <li id="logout" class="menu__logo" style="display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <img class="suaClasse" src="../images/obra360.png" alt="Logo do Obra360" width="100" height="100">
                    </li>
                </ul>
            </nav>
            <script>
        ...
        <ul class="side-menu">
            ...
            <li><a href="sobre_nos_cliente.php"><span class="fa fa-cog"><img class="menu-info" src="../images/info-branco.png" alt="incone informacao"></span>Sobre nós</a></li>
            <li><a id="logout2" href="tela_login_cliente.php"><span class="fa fa-check-square"><img class="menu-info" src="../images/sair-branco.png" alt="incone informacao"></span>Sair</a></li>
        </ul>
        <script>
            document.getElementById('logout').onclick = function() {
                return confirm("Você realmente deseja sair?");
