...
<body>
    ...
    foreach ($obras as $obra) {
        ...
        echo '<img src="../images/message-icon.png" class="m-t">';
        ...
        echo '<img src="../images/local-laranja.png" class="m-t">';
        echo '<h2 class="m-l">' . $obra['endereco_obra'] . '</h2>';
        echo '</div>';

        echo '</div>';
        echo '<div class="icons2">';
        echo '<a onclick="return alertarDelet();" href="delete_obra.php?idObra=' . $obra['id_obra'] . '"><img src="../images/icon-deletar-obra.png" alt="Ícone 1" class="icon2"></a>';

        echo '<a onclick="return alertarEdit();" href="atualizar_detalhes.php?idObra=' . $obra['id_obra'] . '"><img src="../images/edit-obra.png" alt="Ícone 2" class="icon2"></a>';
        echo '</div>';
        echo '</div>';
    }
    ?>
    ...
    <div class="div-sobre">
        ...
        <div>
            <div class="div-icone-sobre">
                <img src="../images/info-azul.png" class="m-t">
            ...
            <div class="div-icone-local-construtora">
                <img src="../images/local-azul.png" class="m-t">
